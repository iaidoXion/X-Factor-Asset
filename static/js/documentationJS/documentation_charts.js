...
//--------------------------------------------------------------------------
  ...
  var DocumentGaugeChartOptions = {
    ...
    var DocumentGaugeChart = new ApexCharts(
      document.querySelector("#DocumentGaugeChart"),
    DocumentGaugeChartOptions
  );
  DocumentGaugeChart.render();
//--------------------------------------------------------------------------
  // BEGIN Guide_CircleChart
