...
function seongnamMap(worldMapData, seongnamNetwork){
    ...
    var svg = d3.select("#seongnamMap").append("svg").attr("width", width).attr("height", height).attr("viewBox", "0 0 879.5 376.92").style("margin-left", '1%');
    var map = svg.append("g").attr("id", "map"),places = svg.append("g").attr("id", "places");
    var projection = d3.geo.mercator().center([127.1094211519, 37.399]).scale(170000).translate([width/2, height/2]);
